...
bookSection.classList.add = "books-display";
bookSection.style.display = "grid";
bookSection.style.gridTemplateColumns = "repeat(auto-fit, minmax(350px, 1fr))";
bookSection.style.gridGap = "20px";

// All the books
bookData.books.forEach((bookVal) => {
  ...
  book.style.padding = "2rem";
  //   book.style.width = "300px";

  book.append(bookImage, bookTitle, bookAuthor, bookButton);
  bookSection.append(book);

  // Filling in the values

  bookImage.src = bookVal.image;
  bookImage.style.width = "70%";
  bookImage.alt = "Logo";
  bookTitle.innerText = bookVal.title;
  bookAuthor.innerText = `Author: ${bookVal.author}`;
  bookButton.style.padding = "0.5rem 1rem";
  bookButton.style.backgroundColor = "teal";
  bookButton.style.color = "white";
  bookButton.style.fontWeight = "700";
  bookButton.style.borderRadius = "5px";
  bookButton.innerText = "Buy Now";
});
