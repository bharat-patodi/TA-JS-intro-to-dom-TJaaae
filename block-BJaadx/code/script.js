...
console.log(document.body.children[6].children.length);
...
topics.firstElementChild.innerText = `This is the first child element`; // Actually there is no child element for the topics variable
...
console.log(typeof fielsetElm.parentElement); // object
